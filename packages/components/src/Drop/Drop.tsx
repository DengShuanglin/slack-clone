...
export class Drop extends React.Component<dropProps> {
  ...
  render() {
    ...
    return (
      <div
        className='component_drop_container'
        style={{
      ...
      >
        <div className='component_drop_header'>
          <span
            className='component_drop_header_icon'
          ...
          >
            <svg
              className={
                this.state.is_arrow_down
                  ? 'icon drop_arrow arrow_down'
                  : 'icon drop_arrow'
              }
              aria-hidden='true'
            >
          ...
          <span
            className='component_drop_title'
            style={{ flex: 1 }}
            onClick={(evt) => {
              if (arrowCallback) arrowCallback(evt)
              this.setState({ is_arrow_down: !this.state.is_arrow_down })
          ...
          <span
            className='component_drop_header_icon component_drop_plus'
            onClick={(evt) => {
