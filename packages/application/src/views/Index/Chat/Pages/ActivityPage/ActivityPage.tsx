              ...
              <div className="virtual_list_item">
                <div className="virtual_list_item_content">
                  <div className="virtual_list_item_content_head">
                    <span style={{ fontWeight: 700, fontSize: '13px' }}># {item.originChannel}</span>
                  </div>
                  <div className="virtual_list_item_content_gutter">
                    ...
                    <div className="virtual_list_item_content_gutter_right">
                      ...
                      <br />
                      <span className="virtual_list_item_content_gutter_msg" style={{ color: 'rgba(97,96,97,1)' }}>已将您添加到</span>
                      <a className='virtual_list_item_content_gutter_msg_href' href="">#{item.toChannel}</a>
                    </div>
                  </div>
                  <div className="virtual_list_item_delete" onClick={() => delete_content(index)}>
                    <svg className="icon virtual_list_item_delete_icon" aria-hidden="true">
