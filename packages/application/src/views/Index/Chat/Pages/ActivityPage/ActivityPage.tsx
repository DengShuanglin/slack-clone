    ...
    <div className='main_chat_contents'>
      ...
      <div className='virtual_list_container'>
        <div
          ...
          style={{ display: demoData.length ? 'block' : 'none' }}
        >
        ...
        <div
          className='virtual_list_container_empty'
          style={{ display: demoData.length ? 'none' : 'flex' }}
        >
          <div className='virtual_list_container_empty_title'>
            实时查看新的活动
          </div>
          <div className='virtual_list_container_empty_description'>
            当人员对你的消息做出回复或提及你或你的关键字时，你就会在这里看到。
          </div>
        </div>
      </div>
    </div>
